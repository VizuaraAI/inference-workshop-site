    ...
    <div>
      <div className="text-center mb-14" data-reveal>
        ...
        <h2 className="headline-lg mb-4">
          ...
          <span className="text-gradient">industry &amp; research leaders.</span>
        </h2>
        <p className="subhead max-w-2xl mx-auto">
          Two months of 1:1 mentorship with Yash Dixit and Dr. Raj Dandekar. One live call every two weeks —
          where they review your progress, guide your next steps, and help you work towards
          a publishable research paper. Get both industrial and research exposure from mentors at Apple, McKinsey, and MIT.
        </p>
      </div>
