...
const phase1 = [
  ...
  { code: 'L3', title: 'Prefill, Decode & KV Cache', desc: 'KV cache mechanics, chunked prefill, prefix caching, prompt caching. KV cache compression: GQA, token eviction, H2O, StreamingLLM' },
  ...
  { code: 'L7', title: 'FlashAttention, Kernel Fusion & Inference Engines', desc: 'IO-aware tiling, online softmax, fused kernels. PagedAttention, continuous/dynamic/in-flight batching, vLLM scheduler internals. Engines: vLLM, SGLang, TensorRT-LLM' },
]

const phase2 = [
  { code: 'L8',  title: 'MoE & Model Parallelism', desc: 'Mixture of experts, expert routing strategies, load balancing, capacity factors. Tensor/pipeline/expert parallelism' },
  ...
  { code: 'L11', title: 'Multimodal Inference', desc: 'Vision encoders, cross-modal attention, vision-language models, image & video generation pipelines' },
  { code: 'L12', title: 'Production Systems', desc: 'Cold starts, canary deployments, cache-aware routing. Guardrails & output filtering. Batch vs online inference' },
  { code: 'L13', title: 'Structured Output & Evals', desc: 'JSON schema, logit biasing, guided decoding. Eval harnesses, benchmarking methodology, latency profiling' },
