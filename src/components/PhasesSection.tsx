...
const devices = [
  ...
  { name: 'Raspberry Pi 4', subtitle: 'ARM · Lab Day 2', desc: 'Quantization experiments on ARM. Compare INT4 vs INT8 latency. Power-aware inference. BCM2711 · Quad-core Cortex-A72 · up to 8GB LPDDR4.', color: '#22C55E', image: '/raspberry-pi-4.jpg', imgClass: 'h-36', Illustration: null, phase: 'Phase 1', phaseColor: '#E91E8C', link: PI4_LINK, note: null },
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {devices.map((d, i) => (
              ...
              >
                ...
                >
                  {d.image ? (
                    <img src={d.image} alt={d.name} className={`${d.imgClass || 'h-36'} w-auto object-contain`} />
                  ) : d.Illustration ? (
                    <d.Illustration />
                  ) : null}
                </div>
